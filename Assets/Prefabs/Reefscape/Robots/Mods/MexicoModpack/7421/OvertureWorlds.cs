...
namespace Prefabs.Reefscape.Robots.Mods.MexicoModpack._7421._7421Worlds
{
    public class OvertureWorlds : ReefscapeRobotBase
    {
        ...
        [Header("Setpoints")]
        [SerializeField] private OvertureWorldsSetpoint stow;
        [SerializeField] private OvertureWorldsSetpoint Algaestow;
        [SerializeField] private OvertureWorldsSetpoint intake;
        [SerializeField] private OvertureWorldsSetpoint intakeback;
        [SerializeField] private OvertureWorldsSetpoint stack;
        [SerializeField] private OvertureWorldsSetpoint l1;
        [SerializeField] private OvertureWorldsSetpoint l1back;
        [SerializeField] private OvertureWorldsSetpoint l2;
        [SerializeField] private OvertureWorldsSetpoint l2Place;
        [SerializeField] private OvertureWorldsSetpoint l2back;
        [SerializeField] private OvertureWorldsSetpoint l2backPlace;
        [SerializeField] private OvertureWorldsSetpoint l3;
        [SerializeField] private OvertureWorldsSetpoint l3Place;
        [SerializeField] private OvertureWorldsSetpoint l3Place2;
        [SerializeField] private OvertureWorldsSetpoint l3back;
        [SerializeField] private OvertureWorldsSetpoint l3backPlace;
        [SerializeField] private OvertureWorldsSetpoint l3backPlace2;
        [SerializeField] private OvertureWorldsSetpoint l4;
        [SerializeField] private OvertureWorldsSetpoint l4Place;
        [SerializeField] private OvertureWorldsSetpoint l4back;
        [SerializeField] private OvertureWorldsSetpoint l4backPlace;
        [SerializeField] private OvertureWorldsSetpoint l4ready;
        [SerializeField] private OvertureWorldsSetpoint l4readyback;
        [SerializeField] private OvertureWorldsSetpoint barge;
        [SerializeField] private OvertureWorldsSetpoint groundAlgae;
        [SerializeField] private OvertureWorldsSetpoint lowAlgae;
        [SerializeField] private OvertureWorldsSetpoint highAlgae;
        [SerializeField] private OvertureWorldsSetpoint lowbackAlgae;
        [SerializeField] private OvertureWorldsSetpoint highbackAlgae;
        [SerializeField] private OvertureWorldsSetpoint climb;
        ...
        private IEnumerator DelayedSetpoint(OvertureWorldsSetpoint firstSetpoint, OvertureWorldsSetpoint secondSetpoint, float delay = 2f)
        {
        ...
        private void SetSetpoint(OvertureWorldsSetpoint setpoint)
        {
