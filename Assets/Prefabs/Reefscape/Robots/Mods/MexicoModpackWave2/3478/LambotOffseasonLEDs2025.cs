...
{
    /// <summary>
    /// Same as LambotLEDs2025, retargeted to the offseason robot's combined LambotOffseasonAutoAlign
    /// component instead of ReefscapeAutoAlign. LambotOffseasonAutoAlign : AutoAlign (same base class
    ...
    ///
    /// Bonus/side-effect worth knowing about: LambotOffseasonAutoAlign handles both reef-branch align AND
    ...
    ///      ReefscapeRobotBase.CurrentSetpoint == Climb/Climbed (see LambotLEDs2025 for why).
    ...
    ///      algae).
    /// </summary>
    public class LambotOffseasonLEDs2025 : MonoBehaviour
    {
        [Header("LED Surfaces")]
        ...
        [SerializeField] private LambotOffseasonAutoAlign align;
        ...
        private void Start()
        {
            ...
            if (align == null) align = GetComponent<LambotOffseasonAutoAlign>();
